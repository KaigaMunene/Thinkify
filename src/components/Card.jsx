...
import Shoe1 from '../assets/images/shoe-1.jpeg';
import Shoe2 from '../assets/images/shoe-2.jpeg';
import Shoe3 from '../assets/images/shoe-3.jpeg';
    ...
    <main className="min-h-screen bg-gradient-to-r from-emerald-400 to-cyan-400 p-8 flex flex-col  md:justify-center items-center">
      ...
      <div className="flex flex-col items-center w-full md:w-1/2 mt-8 md:flex-row md:justify-center md:space-x-5">
        {products.map((product) => (
          ...
          <div
            key={product.id}
            className="w-full md:w-1/4 lg:w-1/4 xl:w-1/4 h-24 lg:h-36 rounded-xl cursor-pointer 
            hover:rotate-6 duration-300 flex justify-center items-center bg-gradient-to-r from-cyan-500 to-blue-500 shadow-xl mb-4"
